app.controller('sitedataController', ['$scope', '$rootScope', 'cookie','uiGridConstants', 'hrmAPIservice', function ($scope, $rootScope, cookie, uiGridConstants, hrmAPIservice) {
    ...
    $scope.getSiteData = () => {
        hrmAPIservice.getSiteData(userData, userData.account_id).then(function(response) {
            $scope.gridOptionsComplex.data = response.data.sitedata;
