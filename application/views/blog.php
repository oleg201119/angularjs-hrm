    ...
    <div class="main">
        ...
        <div class="shell page-shell">
            <div class="container">
                ...
                <p> From time to time,HRM will review this privacy policy and were necessary, update it. If we make changes to this policy, we will take measure to advise users that this policy has changed via an e-mail however it is the responsibility of the user to ensure they keep abreast of updates..
                    <br>
                    <br>
                    <strong>2. Collection and use of personal information</strong>
                </p>
                ...
                <p> Some data which is entered into HRM is stored in the United States of America. HRM has engaged in rigorous due diligence to ensure your data is protected in a substantially similar way, as if the data was stored in Australia.
                    <br> This means, the web hosting provider the HRM use in the United States of America (US) is also bound by strict privacy US laws and they have similar privacy laws (albeit not the same) regarding the security of your information.
                </p>
                ...
                <p> HRM welcomes feedback about privacy issues and will attend to all questions and complaints promptly. You can contact HRM about any privacy issues by e-mailing support@hrmaster.com.au. If the HRM takes more than 30 days to respond to your privacy complaint, or if you are dissatisfied with the outcome, you can make a complaint to the Privacy Commissioner at the Office of the Australian Information Commissioner. The OAIC can be contacted on 1300 363 992 or at www.oaic.gov.au
                </p>
            </div>
             <!-- cols -->
            <section class="cols">
