...
<div class="over_flow">
					...
					<div id="addEdit" class="div_block">
                                            ...
                                            <form class="form-horizontal" onsubmit="return checkemployeeForm()" id="employee_add_form" action="" method="post" accept-charset="utf-8" enctype="multipart/form-data" autocomplete="off">
				          			...
				          			<div class="col-md-12 tabborder">
				          				<div class="row">
					          				<div class="col-md-6">
												...
												<div class="form-group row">
													<label class="control-label col-sm-4" for="emp_password">Password</label>
													<div class="col-sm-8">
                                                                                                            <input type="password" class="form-control" name="emp_password" id="emp_password" placeholder="" value="" autocomplete="emp_password">
														<span id="errormsg_emp_password" style="display:none;" class="text-danger" >Enter Password</span>
