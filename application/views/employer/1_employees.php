<style>
	...
	.tabborder{padding-top:1px !important;}
</style>
		...
		<div class="col-md-12">
			<div class="container">
				<div class="col-md-12 tablemargin" style="padding-right: 100px; padding-left: 60px;">
					...
					<!--************************ Start Add Form *******************************-->
					<br/>
					<div class="box-tools pull-center text-center">
							<?php
							foreach($getAllTabAsPerRole as $role)
							{
								if($this->uri->segment(1) == $role->controller_name && $role->userAdd == '1')
								{
									?>
										...
										-->		
										<span id="add_btn" class="btn btn-info btn-sm">Add Employee</span>
									<?php
								}
							}
							?><br/><br/>
						</div><br/><br/><br/>
					<div id="addEdit" class="div_block hide">
						...
						<form class="form-horizontal" onsubmit="return checkemployeeForm()" id="employee_add_form" action="" method="post" accept-charset="utf-8" enctype="multipart/form-data">
							<ul class="nav nav-tabs">
                            	<li id="t1"><a data-toggle="tab" href="#tab1">Create Employee</a></li>
					            <!--<li id="t1"><a data-toggle="tab hide" href="#tab1">Personal Detail</a></li>
					            <li id="t2" ><a data-toggle="tab hide" href="#tab2">Work Detail</a></li>-->
					        </ul>
					        <div class="tab-contents">
				          		<div id="tab1" class="tab-pane fade in active">
                                    ...
                                    <div class="col-md-12 tabborder">
				          				<div class="row">
                                        	<h3 class="col-md-12">Work Detail</h3>
                                            <br />
					          				<div class="col-md-6">
					          					<div class="form-group row">
				          		...
				          		<!--<div id="tab2s" class="tab-panes fade">
